	...
	redraw() {
		setTimeout(() => {
			window.requestAnimationFrame(() => {
				...
				ctx.fillRect(0, 0, 1000, this.state.canvasHeight);

				if (this.state.currentImage === null) {
					const image = new Image();
					image.onload = () => {
						let height = (image.height / image.width) * 1000;
					...
					ctx.drawImage(this.state.currentImage, this.state.viewerOffsetX, this.state.viewerOffsetY, 1000, this.state.canvasHeight);
